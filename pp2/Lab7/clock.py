...
def change_image(image, t):
    ...
    return im_rotate
main = pygame.image.load('D:\pp\pp2\Lab7\images\main.jpg')
mmm = pygame.image.load('D:\pp\pp2\Lab7\images\mmm.png')
sss = pygame.image.load('D:\pp\pp2\Lab7\images\sss.png')
